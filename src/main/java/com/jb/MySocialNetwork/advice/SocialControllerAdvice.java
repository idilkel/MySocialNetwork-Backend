...
public class SocialControllerAdvice {
    ...
    @ExceptionHandler(value = SocialNetworkSecurityException.class)
    public ResponseEntity<?> handleSecException(SocialNetworkSecurityException e) {
